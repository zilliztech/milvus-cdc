...
// 	readerObj     api.Reader
// }
//
// func NewCdcTask(taskID string, r api.Reader, w func() error) *CDCTask {
// 	task := &CDCTask{
// 		id: taskID,
// 		// factory: f,
// 		// callback:      c,
...
// 				continue
// 			}
// 			c.readerObj.StartRead(context.Background())
...
// // 			collectionID = msg.TmpCollectionID
