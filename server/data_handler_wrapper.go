...
// }
//
// func (d *DataHandlerWrapper) ReplicateMessage(ctx context.Context, param *writer.ReplicateMessageParam) (err error) {
// 	defer func() {
// 		d.metric(util.RPCRequestCollectionName, "ReplicateMessage", err != nil)
// 	}()
// 	err = d.handler.ReplicateMessage(ctx, param)
// 	return
// }
