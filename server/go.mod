...
require (
	...
	github.com/milvus-io/milvus/client/v2 v2.0.0-20250227064359-3b7b7e7e99aa // indirect
...
replace (
	...
	github.com/milvus-io/milvus/pkg/v2 => github.com/SimFG/milvus/pkg/v2 v2.0.0-20250320070909-f2283532de82 // master
