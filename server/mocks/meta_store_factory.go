...
// GetReplicateStore provides a mock function with given fields: ctx
func (_m *MetaStoreFactory) GetReplicateStore(ctx context.Context) api.ReplicateStore {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for GetReplicateStore")
	}

	var r0 api.ReplicateStore
	if rf, ok := ret.Get(0).(func(context.Context) api.ReplicateStore); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(api.ReplicateStore)
		}
	}
...
// MetaStoreFactory_GetReplicateStore_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetReplicateStore'
type MetaStoreFactory_GetReplicateStore_Call struct {
	*mock.Call
}

// GetReplicateStore is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MetaStoreFactory_Expecter) GetReplicateStore(ctx interface{}) *MetaStoreFactory_GetReplicateStore_Call {
	return &MetaStoreFactory_GetReplicateStore_Call{Call: _e.mock.On("GetReplicateStore", ctx)}
}

func (_c *MetaStoreFactory_GetReplicateStore_Call) Run(run func(ctx context.Context)) *MetaStoreFactory_GetReplicateStore_Call {
...
func (_c *MetaStoreFactory_GetReplicateStore_Call) Return(_a0 api.ReplicateStore) *MetaStoreFactory_GetReplicateStore_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MetaStoreFactory_GetReplicateStore_Call) RunAndReturn(run func(context.Context) api.ReplicateStore) *MetaStoreFactory_GetReplicateStore_Call {
	_c.Call.Return(run)
	return _c
}

// GetTaskCollectionPositionMetaStore provides a mock function with given fields: ctx
func (_m *MetaStoreFactory) GetTaskCollectionPositionMetaStore(ctx context.Context) serverapi.MetaStore[*meta.TaskCollectionPosition] {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for GetTaskCollectionPositionMetaStore")
	}

	var r0 serverapi.MetaStore[*meta.TaskCollectionPosition]
	if rf, ok := ret.Get(0).(func(context.Context) serverapi.MetaStore[*meta.TaskCollectionPosition]); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(serverapi.MetaStore[*meta.TaskCollectionPosition])
		}
	}
...
func (_c *MetaStoreFactory_GetTaskCollectionPositionMetaStore_Call) Return(_a0 serverapi.MetaStore[*meta.TaskCollectionPosition]) *MetaStoreFactory_GetTaskCollectionPositionMetaStore_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MetaStoreFactory_GetTaskCollectionPositionMetaStore_Call) RunAndReturn(run func(context.Context) serverapi.MetaStore[*meta.TaskCollectionPosition]) *MetaStoreFactory_GetTaskCollectionPositionMetaStore_Call {
	_c.Call.Return(run)
	return _c
}

// GetTaskInfoMetaStore provides a mock function with given fields: ctx
func (_m *MetaStoreFactory) GetTaskInfoMetaStore(ctx context.Context) serverapi.MetaStore[*meta.TaskInfo] {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for GetTaskInfoMetaStore")
	}

	var r0 serverapi.MetaStore[*meta.TaskInfo]
	if rf, ok := ret.Get(0).(func(context.Context) serverapi.MetaStore[*meta.TaskInfo]); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(serverapi.MetaStore[*meta.TaskInfo])
		}
	}
...
func (_c *MetaStoreFactory_GetTaskInfoMetaStore_Call) Return(_a0 serverapi.MetaStore[*meta.TaskInfo]) *MetaStoreFactory_GetTaskInfoMetaStore_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MetaStoreFactory_GetTaskInfoMetaStore_Call) RunAndReturn(run func(context.Context) serverapi.MetaStore[*meta.TaskInfo]) *MetaStoreFactory_GetTaskInfoMetaStore_Call {
	_c.Call.Return(run)
	return _c
}
