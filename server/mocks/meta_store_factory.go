...
func (_c *MetaStoreFactory_GetTaskCollectionPositionMetaStore_Call) Return(_a0 store.MetaStore[*meta.TaskCollectionPosition]) *MetaStoreFactory_GetTaskCollectionPositionMetaStore_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MetaStoreFactory_GetTaskCollectionPositionMetaStore_Call) RunAndReturn(run func(context.Context) store.MetaStore[*meta.TaskCollectionPosition]) *MetaStoreFactory_GetTaskCollectionPositionMetaStore_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MetaStoreFactory_GetTaskInfoMetaStore_Call) Return(_a0 store.MetaStore[*meta.TaskInfo]) *MetaStoreFactory_GetTaskInfoMetaStore_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MetaStoreFactory_GetTaskInfoMetaStore_Call) RunAndReturn(run func(context.Context) store.MetaStore[*meta.TaskInfo]) *MetaStoreFactory_GetTaskInfoMetaStore_Call {
	_c.Call.Return(run)
	return _c
}
