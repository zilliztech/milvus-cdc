...
func (_e *MsgStream_Expecter) CheckTopicValid(channel interface{}) *MsgStream_CheckTopicValid_Call {
	return &MsgStream_CheckTopicValid_Call{Call: _e.mock.On("CheckTopicValid", channel)}
}

func (_c *MsgStream_CheckTopicValid_Call) Run(run func(channel string)) *MsgStream_CheckTopicValid_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MsgStream_CheckTopicValid_Call) Return(_a0 error) *MsgStream_CheckTopicValid_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MsgStream_CheckTopicValid_Call) RunAndReturn(run func(string) error) *MsgStream_CheckTopicValid_Call {
	_c.Call.Return(run)
	return _c
}
