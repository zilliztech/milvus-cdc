...
func (_m *MetaOp) GetAllCollection(ctx context.Context, filter api.CollectionFilter) ([]*etcdpb.CollectionInfo, error) {
	ret := _m.Called(ctx, filter)

	if len(ret) == 0 {
		panic("no return value specified for GetAllCollection")
	}

	var r0 []*etcdpb.CollectionInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, api.CollectionFilter) ([]*etcdpb.CollectionInfo, error)); ok {
		return rf(ctx, filter)
	}
	if rf, ok := ret.Get(0).(func(context.Context, api.CollectionFilter) []*etcdpb.CollectionInfo); ok {
		r0 = rf(ctx, filter)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*etcdpb.CollectionInfo)
		}
	}
...
func (_c *MetaOp_GetAllCollection_Call) Return(_a0 []*etcdpb.CollectionInfo, _a1 error) *MetaOp_GetAllCollection_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MetaOp_GetAllCollection_Call) RunAndReturn(run func(context.Context, api.CollectionFilter) ([]*etcdpb.CollectionInfo, error)) *MetaOp_GetAllCollection_Call {
	_c.Call.Return(run)
	return _c
}

// GetAllDroppedObj provides a mock function with no fields
func (_m *MetaOp) GetAllDroppedObj() map[string]map[string]uint64 {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetAllDroppedObj")
	}
...
func (_m *MetaOp) GetAllPartition(ctx context.Context, filter api.PartitionFilter) ([]*etcdpb.PartitionInfo, error) {
	ret := _m.Called(ctx, filter)

	if len(ret) == 0 {
		panic("no return value specified for GetAllPartition")
	}

	var r0 []*etcdpb.PartitionInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, api.PartitionFilter) ([]*etcdpb.PartitionInfo, error)); ok {
		return rf(ctx, filter)
	}
	if rf, ok := ret.Get(0).(func(context.Context, api.PartitionFilter) []*etcdpb.PartitionInfo); ok {
		r0 = rf(ctx, filter)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*etcdpb.PartitionInfo)
		}
	}
...
func (_c *MetaOp_GetAllPartition_Call) Return(_a0 []*etcdpb.PartitionInfo, _a1 error) *MetaOp_GetAllPartition_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MetaOp_GetAllPartition_Call) RunAndReturn(run func(context.Context, api.PartitionFilter) ([]*etcdpb.PartitionInfo, error)) *MetaOp_GetAllPartition_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MetaOp) GetCollectionNameByID(ctx context.Context, id int64) string {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetCollectionNameByID")
	}
...
func (_m *MetaOp) GetDatabaseInfoForCollection(ctx context.Context, id int64) model.DatabaseInfo {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetDatabaseInfoForCollection")
	}
...
// StartWatch provides a mock function with no fields
