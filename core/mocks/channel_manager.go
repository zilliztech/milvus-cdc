...
func (_m *ChannelManager) AddPartition(ctx context.Context, dbInfo *model.DatabaseInfo, collectionInfo *etcdpb.CollectionInfo, partitionInfo *etcdpb.PartitionInfo) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *model.DatabaseInfo, *etcdpb.CollectionInfo, *etcdpb.PartitionInfo) error); ok {
...
//   - collectionInfo *etcdpb.CollectionInfo
//   - partitionInfo *etcdpb.PartitionInfo
...
func (_c *ChannelManager_AddPartition_Call) Run(run func(ctx context.Context, dbInfo *model.DatabaseInfo, collectionInfo *etcdpb.CollectionInfo, partitionInfo *etcdpb.PartitionInfo)) *ChannelManager_AddPartition_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*model.DatabaseInfo), args[2].(*etcdpb.CollectionInfo), args[3].(*etcdpb.PartitionInfo))
	})
	return _c
}
...
func (_c *ChannelManager_AddPartition_Call) RunAndReturn(run func(context.Context, *model.DatabaseInfo, *etcdpb.CollectionInfo, *etcdpb.PartitionInfo) error) *ChannelManager_AddPartition_Call {
	_c.Call.Return(run)
	return _c
}

// GetChannelChan provides a mock function with no fields
...
// GetEventChan provides a mock function with no fields
...
func (_m *ChannelManager) StartReadCollection(ctx context.Context, db *model.DatabaseInfo, info *etcdpb.CollectionInfo, seekPositions []*msgpb.MsgPosition, channelStartTsMap map[string]uint64) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *model.DatabaseInfo, *etcdpb.CollectionInfo, []*msgpb.MsgPosition, map[string]uint64) error); ok {
...
func (_c *ChannelManager_StartReadCollection_Call) Run(run func(ctx context.Context, db *model.DatabaseInfo, info *etcdpb.CollectionInfo, seekPositions []*msgpb.MsgPosition, channelStartTsMap map[string]uint64)) *ChannelManager_StartReadCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*model.DatabaseInfo), args[2].(*etcdpb.CollectionInfo), args[3].([]*msgpb.MsgPosition), args[4].(map[string]uint64))
	})
	return _c
}
...
func (_c *ChannelManager_StartReadCollection_Call) RunAndReturn(run func(context.Context, *model.DatabaseInfo, *etcdpb.CollectionInfo, []*msgpb.MsgPosition, map[string]uint64) error) *ChannelManager_StartReadCollection_Call {
	_c.Call.Return(run)
	return _c
}

// StopReadCollection provides a mock function with given fields: ctx, info
func (_m *ChannelManager) StopReadCollection(ctx context.Context, info *etcdpb.CollectionInfo) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *etcdpb.CollectionInfo) error); ok {
		r0 = rf(ctx, info)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *ChannelManager_StopReadCollection_Call) Run(run func(ctx context.Context, info *etcdpb.CollectionInfo)) *ChannelManager_StopReadCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*etcdpb.CollectionInfo))
	})
	return _c
}
...
func (_c *ChannelManager_StopReadCollection_Call) RunAndReturn(run func(context.Context, *etcdpb.CollectionInfo) error) *ChannelManager_StopReadCollection_Call {
	_c.Call.Return(run)
	return _c
}
