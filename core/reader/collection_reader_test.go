...
// 	var options []config.Option[*reader.CollectionReader]
...
// 		defer call.Unset()
// 		_, err := reader.NewCollectionReader(append(options,
...
// 			collectionReader, err := reader.NewCollectionReader(append(options,
